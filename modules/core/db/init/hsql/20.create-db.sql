-- begin LIBRARY_BOOK
alter table LIBRARY_BOOK add constraint FK_LIBRARY_BOOK_LITERATURE_TYPE_ID foreign key (LITERATURE_TYPE_ID) references LIBRARY_LITERATURE_TYPE(ID)^
create index IDX_LIBRARY_BOOK_LITERATURE_TYPE on LIBRARY_BOOK (LITERATURE_TYPE_ID)^
-- end LIBRARY_BOOK
-- begin LIBRARY_BOOK_PUBLICATION
alter table LIBRARY_BOOK_PUBLICATION add constraint FK_LIBRARY_BOOK_PUBLICATION_BOOK_ID foreign key (BOOK_ID) references LIBRARY_BOOK(ID)^
alter table LIBRARY_BOOK_PUBLICATION add constraint FK_LIBRARY_BOOK_PUBLICATION_PUBLISHER_ID foreign key (PUBLISHER_ID) references LIBRARY_PUBLISHER(ID)^
alter table LIBRARY_BOOK_PUBLICATION add constraint FK_LIBRARY_BOOK_PUBLICATION_TOWN_ID foreign key (TOWN_ID) references LIBRARY_TOWN(ID)^
...
alter table LIBRARY_BOOK_INSTANCE add constraint FK_LIBRARY_BOOK_INSTANCE_BOOK_PUBLICATION_ID foreign key (BOOK_PUBLICATION_ID) references LIBRARY_BOOK_PUBLICATION(ID)^
alter table LIBRARY_BOOK_INSTANCE add constraint FK_LIBRARY_BOOK_INSTANCE_LIBRARY_DEPARTMENT_ID foreign key (LIBRARY_DEPARTMENT_ID) references LIBRARY_LIBRARY_DEPARTMENT(ID)^
